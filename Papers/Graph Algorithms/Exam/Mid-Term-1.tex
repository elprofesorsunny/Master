...
\begin{document}
    ...
    \begin{itemize}
        ...
        \begin{center}
            ...
            \begin{tikzpicture}
                ...
                \node[circle, draw=none, fill=black, thick] (A) at (0,0) {};
                \node[circle, draw=none, fill=black, thick] (B) at (2,0) {};
                \node[circle, draw=none, fill=black, thick] (C) at (4,0) {};
                \node[circle, draw, thick] (D) at (0,3) {};
                \node[circle, draw, thick] (E) at (2,3) {};
                \node[circle, draw, thick] (F) at (4,3) {};
        ...
        \begin{center}
            ...
            \begin{tikzpicture}
                ...
                \node[circle, draw=none, fill=black, thick] (A) at (6,0) {};
                \node[circle, draw=none, fill=black, thick] (B) at (8,0) {};
                \node[circle, draw=none, fill=black, thick] (C) at (10,0) {};
                \node[circle, draw=none, fill=black, thick] (D) at (12,0) {};
                \node[circle, draw, thick] (E) at (7,3) {};
                \node[circle, draw, thick] (F) at (9,3) {};
                \node[circle, draw, thick] (G) at (11,3) {};
    ...
    همینطور در گراف دوبخشی کامل همه رئوس یک زیرمجموعه با همه رئوس زیرمجموعه دیگر به صورت کامل متصل هستند. به عبارت دیگر، هر راس در یک زیرمجموعه با همه راس‌های زیرمجموعه دیگر متصل است. به طور مثال هر دو گرافِ زیر یک گرافِ دوبخشی کامل هستند.
    ...
    \paragraph{سوال:} ترتیب توپولوژیک\footnote{\hspace{2pt}Order Topological} گراف زیر را به دست آورید.
