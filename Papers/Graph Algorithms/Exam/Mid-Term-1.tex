...
\begin{document}
    ...
    \begin{center}
        ...
        \begin{tikzpicture}
            ...
            \node[circle, draw, thick] (D) at (0,2) {};
            \node[circle, draw, thick] (E) at (2,2) {};
            \node[circle, draw, thick] (F) at (4,2) {};
    ...
    \paragraph{سوال:} نظم توپولوژیکی\footnote{\hspace{2pt}Order Topological} گراف زیر را به دست آورید.
