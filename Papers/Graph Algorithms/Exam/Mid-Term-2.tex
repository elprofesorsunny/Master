...
\begin{document}
    ...
    \begin{itemize}
        ...
        به عنوان مثال می‌نوان گراف زیر را در نظر گرفت و با توجه به گراف زیر الگوریتم جستجوی عمق اول را برای آن به صورت زیر نوشت.
        ...
        \begin{center}
            ...
            \begin{tikzpicture}
                ...
                \node[circle, draw, thick] (5) at (3,1) {5};
                \node[circle, draw, thick] (6) at (3,0) {6};
                \node[circle, draw, thick] (7) at (4.5,1) {7};
