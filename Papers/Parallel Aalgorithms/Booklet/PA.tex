            ...
            \subsection{SIMD Architecture}
                ...
                \subsubsection{{\bold > \hspace{10pt} Interconnection Network (IN) SIMD Computers}}
                    ...
                    \begin{minipage}{0.4925\linewidth}
                        ...
                        \begin{tcolorbox}[colframe=black!50, colback=white, size=small]
                            ...
                            \begin{center}
                                \begin{tikzpicture}
                                    ...
                                    \foreach \i in {1,...,6}
                                        \node[circle, fill=black, minimum size=5pt, inner sep=0pt] (n\i) at (\i,0) {};
                                ...
                                \begin{tikzpicture}
                                    ...
                                    \foreach \x in {1,2,3,4}
                                        \foreach \y in {1,2,3,4}
                                            \node[circle, fill=black, minimum size=5pt, inner sep=0pt] (n\x\y) at (\x, \y) {};
                        ...
                        \begin{tcolorbox}[colframe=black!50, colback=white, size=small]
                            ...
                            \begin{center}
                                \begin{tikzpicture}
                                    ...
                                    \node[circle, fill=black, minimum size=5pt, inner sep=0pt] (n1) at (0,0) {};
                                    \node[circle, fill=black, minimum size=5pt, inner sep=0pt] (n2) at (2,0) {};
                                    \node[circle, fill=black, minimum size=5pt, inner sep=0pt] (n3) at (1,1) {};
                                    \node[circle, fill=black, minimum size=5pt, inner sep=0pt] (n4) at (1,-1) {};
                                    \node[circle, fill=black, minimum size=5pt, inner sep=0pt] (n5) at (0.3,0.7) {};
                                    \node[circle, fill=black, minimum size=5pt, inner sep=0pt] (n6) at (0.3,-0.7) {};
                                    \node[circle, fill=black, minimum size=5pt, inner sep=0pt] (n7) at (1.7,0.7) {};
                                    \node[circle, fill=black, minimum size=5pt, inner sep=0pt] (n8) at (1.7,-0.7) {};
                        ...
                        \end{tcolorbox} % Completely Connected
                        ...
                        \begin{tcolorbox}[colframe=black!50, colback=white, size=small]
                            ...
                            \begin{center}
                                \begin{tikzpicture}
                                    ...
                                    \node[circle, fill=black, minimum size=5pt, inner sep=0pt] (n1) at (-1,0) {};
                                    \node[circle, fill=black, minimum size=5pt, inner sep=0pt] (n2) at (-0.9,0.38) {};
                                    \node[circle, fill=black, minimum size=5pt, inner sep=0pt] (n3) at (-0.7,0.7) {};
                                    \node[circle, fill=black, minimum size=5pt, inner sep=0pt] (n4) at (-0.38,0.9) {};
                                    \node[circle, fill=black, minimum size=5pt, inner sep=0pt] (n5) at (0,1) {};
                                    \node[circle, fill=black, minimum size=5pt, inner sep=0pt] (n6) at (0.38,0.9) {};
                                    \node[circle, fill=black, minimum size=5pt, inner sep=0pt] (n7) at (0.7,0.7) {};
                                    \node[circle, fill=black, minimum size=5pt, inner sep=0pt] (n8) at (0.9,0.38) {};
                                    \node[circle, fill=black, minimum size=5pt, inner sep=0pt] (n9) at (1,0) {};
                                    \node[circle, fill=black, minimum size=5pt, inner sep=0pt] (n10) at (0.9,-0.38) {};
                                    \node[circle, fill=black, minimum size=5pt, inner sep=0pt] (n11) at (0.7,-0.7) {};
                                    \node[circle, fill=black, minimum size=5pt, inner sep=0pt] (n12) at (0.38,-0.9) {};
                                    \node[circle, fill=black, minimum size=5pt, inner sep=0pt] (n13) at (0,-1) {};
                                    \node[circle, fill=black, minimum size=5pt, inner sep=0pt] (n14) at (-0.38,-0.9) {};
                                    \node[circle, fill=black, minimum size=5pt, inner sep=0pt] (n15) at (-0.7,-0.7) {};
                                    \node[circle, fill=black, minimum size=5pt, inner sep=0pt] (n16) at (-0.9,-0.38) {};
                        ...
                        \begin{tcolorbox}[colframe=black!50, colback=white, size=small]
                            ...
                            \begin{center}
                                \begin{tikzpicture}
                                    ...
                                    \node[circle, fill=black, minimum size=5pt, inner sep=0pt] (root) at (0,2) {};
                                    
                                    \node[circle, fill=black, minimum size=5pt, inner sep=0pt] (n1) at (-1,1) {};
                                    \node[circle, fill=black, minimum size=5pt, inner sep=0pt] (n2) at (1,1) {};
                                    
                                    \node[circle, fill=black, minimum size=5pt, inner sep=0pt] (n3) at (-1.5,0) {};
                                    \node[circle, fill=black, minimum size=5pt, inner sep=0pt] (n4) at (-0.5,0) {};
                                    \node[circle, fill=black, minimum size=5pt, inner sep=0pt] (n5) at (0.5,0) {};
                                    \node[circle, fill=black, minimum size=5pt, inner sep=0pt] (n6) at (1.5,0) {};
                        ...
                        \begin{tcolorbox}[colframe=black!50, colback=white, size=small]
                            ...
                            \begin{center}
                                \begin{tikzpicture}
                                    ...
                                    \node[circle, fill=black, minimum size=5pt, inner sep=0pt] (n1) at (0,0) {};
                                    \node[circle, fill=black, minimum size=5pt, inner sep=0pt] (n2) at (0,1) {};
                                    \node[circle, fill=black, minimum size=5pt, inner sep=0pt] (n3) at (1,0) {};
                                    \node[circle, fill=black, minimum size=5pt, inner sep=0pt] (n4) at (1,1) {};

                                    \node[circle, fill=black, minimum size=5pt, inner sep=0pt] (n5) at (0.3,0.3) {};
                                    \node[circle, fill=black, minimum size=5pt, inner sep=0pt] (n6) at (0.3,1.3) {};
                                    \node[circle, fill=black, minimum size=5pt, inner sep=0pt] (n7) at (1.3,0.3) {};
                                    \node[circle, fill=black, minimum size=5pt, inner sep=0pt] (n8) at (1.3,1.3) {};

                                    \node[circle, fill=black, minimum size=5pt, inner sep=0pt] (n9) at (2,0) {};
                                    \node[circle, fill=black, minimum size=5pt, inner sep=0pt] (n10) at (2,1) {};
                                    \node[circle, fill=black, minimum size=5pt, inner sep=0pt] (n11) at (3,0) {};
                                    \node[circle, fill=black, minimum size=5pt, inner sep=0pt] (n12) at (3,1) {};
                                    
                                    \node[circle, fill=black, minimum size=5pt, inner sep=0pt] (n13) at (2.3,0.3) {};
                                    \node[circle, fill=black, minimum size=5pt, inner sep=0pt] (n14) at (2.3,1.3) {};
                                    \node[circle, fill=black, minimum size=5pt, inner sep=0pt] (n15) at (3.3,0.3) {};
                                    \node[circle, fill=black, minimum size=5pt, inner sep=0pt] (n16) at (3.3,1.3) {};
                                    ...
                                    \draw[dashed] (n3) .. controls (1.5,-0.2) .. (n9);
                                    \draw[dashed] (n7) .. controls (1.8,0.1) .. (n13);
                                    \draw[dashed] (n4) .. controls (1.5,1.2) .. (n10);
                                    \draw[dashed] (n8) .. controls (1.8,1.5) .. (n14);

                                    \draw[dashed] (n1) .. controls (1.5,-0.8) .. (n11);
                                    \draw[dashed] (n5) .. controls (1.8,-0.5) .. (n15);
                                    \draw[dashed] (n2) .. controls (1.5,1.8) .. (n12);
                                    \draw[dashed] (n6) .. controls (1.8,2.1) .. (n16);
                        ...
                        \begin{tcolorbox}[colframe=black!50, colback=white, size=small]
                            ...
                            \begin{center}
                                \begin{tikzpicture}
                                    ...
                                    \node[draw, minimum width=3.8cm, minimum height=0.8cm] (LMain1) at (0,4.2) {};

                                    \node[draw, minimum width=0.5cm, minimum height=0.5cm] (L11) at (-1.5,4.2) {};
                                    \node[draw, minimum width=0.5cm, minimum height=0.5cm] (L12) at (-0.5,4.2) {};
                                    \node[draw, minimum width=0.5cm, minimum height=0.5cm] (L13) at (0.5,4.2) {};
                                    \node[draw, minimum width=0.5cm, minimum height=0.5cm] (L14) at (1.5,4.2) {};
                                    
                                    \node[draw, minimum width=1.8cm, minimum height=0.8cm] (LMain2) at (1.3,3) {};
                                    
                                    \node[draw, minimum width=0.5cm, minimum height=0.5cm] (L21) at (-1.8,3) {};
                                    \node[draw, minimum width=0.5cm, minimum height=0.5cm] (L22) at (-0.8,3) {};
                                    
                                    \node[draw, minimum width=1.8cm, minimum height=0.8cm] (LMain3) at (-1.3,3) {};

                                    \node[draw, minimum width=0.5cm, minimum height=0.5cm] (L23) at (0.8,3) {};
                                    \node[draw, minimum width=0.5cm, minimum height=0.5cm] (L24) at (1.8,3) {};
                                    
                                    %%%%%%%%%%%%%%%%%%%%%

                                    \node[circle, fill=black, minimum size=5pt, inner sep=0pt] (n1) at (-3.0,2) {};
                                    \node[circle, fill=black, minimum size=5pt, inner sep=0pt] (n2) at (-2.6,2) {};
                                    \node[circle, fill=black, minimum size=5pt, inner sep=0pt] (n3) at (-2.2,2) {};
                                    \node[circle, fill=black, minimum size=5pt, inner sep=0pt] (n4) at (-1.8,2) {};

                                    \node[circle, fill=black, minimum size=5pt, inner sep=0pt] (n5) at (-1.4,2) {};
                                    \node[circle, fill=black, minimum size=5pt, inner sep=0pt] (n6) at (-1.0,2) {};
                                    \node[circle, fill=black, minimum size=5pt, inner sep=0pt] (n7) at (-0.6,2) {};
                                    \node[circle, fill=black, minimum size=5pt, inner sep=0pt] (n8) at (-0.2,2) {};
                                    
                                    \node[circle, fill=black, minimum size=5pt, inner sep=0pt] (n9) at (0.2,2) {};
                                    \node[circle, fill=black, minimum size=5pt, inner sep=0pt] (n10) at (0.6,2) {};
                                    \node[circle, fill=black, minimum size=5pt, inner sep=0pt] (n11) at (1.0,2) {};
                                    \node[circle, fill=black, minimum size=5pt, inner sep=0pt] (n12) at (1.4,2) {};
                                    
                                    \node[circle, fill=black, minimum size=5pt, inner sep=0pt] (n13) at (1.8,2) {};
                                    \node[circle, fill=black, minimum size=5pt, inner sep=0pt] (n14) at (2.2,2) {};
                                    \node[circle, fill=black, minimum size=5pt, inner sep=0pt] (n15) at (2.6,2) {};
                                    \node[circle, fill=black, minimum size=5pt, inner sep=0pt] (n16) at (3.0,2) {};

                                    %%%%%%%%%%%%%%%%%%%%%

                                    \draw (L11.south) -- (L21.north);
                                    \draw (L11.south) -- (L22.north);

                                    \draw (L13.south) -- (L23.north);
                                    \draw (L13.south) -- (L24.north);

                                    \draw[dashed] (L12.south) -- (L21.north);
                                    \draw[dashed] (L12.south) -- (L22.north);

                                    \draw[dashed] (L14.south) -- (L23.north);
                                    \draw[dashed] (L14.south) -- (L24.north);
                        ...
                        \begin{tcolorbox}[colframe=black!50, colback=white, size=small]
                            ...
                            \begin{center}
                                \begin{tikzpicture}
                                    ...
                                    \node[circle, fill=black, minimum size=5pt, inner sep=0pt] (n1) at (0,0) {};
                                    \node[circle, fill=black, minimum size=5pt, inner sep=0pt] (n2) at (0.15,0.45) {};
                                    \node[circle, fill=black, minimum size=5pt, inner sep=0pt] (n3) at (0.15,-0.45) {};
                                    \node[circle, fill=black, minimum size=5pt, inner sep=0pt] (n4) at (0.45,0.8) {};
                                    \node[circle, fill=black, minimum size=5pt, inner sep=0pt] (n5) at (0.45,-0.8) {};
                                    \node[circle, fill=black, minimum size=5pt, inner sep=0pt] (n6) at (0.87,1) {};
                                    \node[circle, fill=black, minimum size=5pt, inner sep=0pt] (n7) at (0.87,-1) {};
                                    \node[circle, fill=black, minimum size=5pt, inner sep=0pt] (n8) at (1.32,1) {};
                                    \node[circle, fill=black, minimum size=5pt, inner sep=0pt] (n9) at (1.32,-1) {};
                                    \node[circle, fill=black, minimum size=5pt, inner sep=0pt] (n10) at (1.74,0.8) {};
                                    \node[circle, fill=black, minimum size=5pt, inner sep=0pt] (n11) at (1.74,-0.8) {};
                                    \node[circle, fill=black, minimum size=5pt, inner sep=0pt] (n12) at (2.04,0.45) {};
                                    \node[circle, fill=black, minimum size=5pt, inner sep=0pt] (n13) at (2.04,-0.45) {};
                                    \node[circle, fill=black, minimum size=5pt, inner sep=0pt] (n14) at (2.19,0) {};
                        ...
                        \begin{tcolorbox}[colframe=black!50, colback=white, size=small]
                            ...
                            \begin{center}
                                \begin{tikzpicture}
                                    ...
                                    \draw (n11) .. controls (0.5,0.5) and (0.5,4.5) .. (n14);
                                    \draw (n21) .. controls (1.5,0.5) and (1.5,4.5) .. (n24);
                                    \draw (n31) .. controls (2.5,0.5) and (2.5,4.5) .. (n34);
                                    \draw (n41) .. controls (3.5,0.5) and (3.5,4.5) .. (n44);

                                    \draw (n11) .. controls (0.5,1.5) and (4.5,1.5) .. (n41);
                                    \draw (n12) .. controls (0.5,2.5) and (4.5,2.5) .. (n42);
                                    \draw (n13) .. controls (0.5,3.5) and (4.5,3.5) .. (n43);
                                    \draw (n14) .. controls (0.5,4.5) and (4.5,4.5) .. (n44);

                                \end{tikzpicture}
                            \end{center}

                        \end{tcolorbox} % 2D Torus
                    ...
                    \begin{minipage}{0.4925\linewidth}
                        ...
                        \begin{tcolorbox}[colframe=black!50, colback=white, size=small]
                            ...
                            \begin{center}
                                \begin{tikzpicture}
                                    ...
                                    \draw (n11) .. controls (2,0) and (1,5) .. (n24);
                                    \draw (n21) .. controls (3,0) and (2,5) .. (n34);
                                    \draw (n31) .. controls (4,0) and (3,5) .. (n44);
                                    \draw (n41) .. controls (5,2) and (5,6) .. (n14);

                                    \draw (n14) .. controls (0,3) and (5,4) .. (n43);
                                    \draw (n13) .. controls (0,2) and (5,3) .. (n42);
                                    \draw (n12) .. controls (0,1) and (5,2) .. (n41);
                                    \draw (n11) .. controls (0,2) and (0,6) .. (n44);
                        ...
                        \end{tcolorbox} % 2D Tour (variation 2)
                    ...
                    \begin{minipage}{1\linewidth}
                        ...
                        \begin{tcolorbox}[colframe=black!50, colback=white, size=small]
                            ...
                            \begin{center}
                                ...
                                \node[circle, fill=black, minimum size=5pt, inner sep=0pt] (n211) at (1.4,1.25) {}; 
                                \node[circle, fill=black, minimum size=5pt, inner sep=0pt] (n221) at (2.4,1.25) {}; 
                                \node[circle, fill=black, minimum size=5pt, inner sep=0pt] (n231) at (3.4,1.25) {}; 
                                \node[circle, fill=black, minimum size=5pt, inner sep=0pt] (n241) at (4.4,1.25) {};

                                \node[circle, fill=black, minimum size=5pt, inner sep=0pt] (n212) at (1.4,2.25) {};
                                \node[circle, fill=black, minimum size=5pt, inner sep=0pt] (n222) at (2.4,2.25) {};
                                \node[circle, fill=black, minimum size=5pt, inner sep=0pt] (n232) at (3.4,2.25) {};
                                \node[circle, fill=black, minimum size=5pt, inner sep=0pt] (n242) at (4.4,2.25) {};
                                
                                \node[circle, fill=black, minimum size=5pt, inner sep=0pt] (n223) at (2.4,3.25) {};
                                \node[circle, fill=black, minimum size=5pt, inner sep=0pt] (n213) at (1.4,3.25) {};
                                \node[circle, fill=black, minimum size=5pt, inner sep=0pt] (n233) at (3.4,3.25) {};
                                \node[circle, fill=black, minimum size=5pt, inner sep=0pt] (n243) at (4.4,3.25) {};
                                
                                \node[circle, fill=black, minimum size=5pt, inner sep=0pt] (n214) at (1.4,4.25) {};
                                \node[circle, fill=black, minimum size=5pt, inner sep=0pt] (n224) at (2.4,4.25) {};
                                \node[circle, fill=black, minimum size=5pt, inner sep=0pt] (n234) at (3.4,4.25) {};
                                \node[circle, fill=black, minimum size=5pt, inner sep=0pt] (n244) at (4.4,4.25) {};
                                ...
                                \node[circle, fill=black, minimum size=5pt, inner sep=0pt] (n311) at (1.8,1.5) {}; 
                                \node[circle, fill=black, minimum size=5pt, inner sep=0pt] (n321) at (2.8,1.5) {}; 
                                \node[circle, fill=black, minimum size=5pt, inner sep=0pt] (n331) at (3.8,1.5) {}; 
                                \node[circle, fill=black, minimum size=5pt, inner sep=0pt] (n341) at (4.8,1.5) {};

                                \node[circle, fill=black, minimum size=5pt, inner sep=0pt] (n312) at (1.8,2.5) {};
                                \node[circle, fill=black, minimum size=5pt, inner sep=0pt] (n322) at (2.8,2.5) {};
                                \node[circle, fill=black, minimum size=5pt, inner sep=0pt] (n332) at (3.8,2.5) {};
                                \node[circle, fill=black, minimum size=5pt, inner sep=0pt] (n342) at (4.8,2.5) {};
                                
                                \node[circle, fill=black, minimum size=5pt, inner sep=0pt] (n323) at (2.8,3.5) {};
                                \node[circle, fill=black, minimum size=5pt, inner sep=0pt] (n313) at (1.8,3.5) {};
                                \node[circle, fill=black, minimum size=5pt, inner sep=0pt] (n333) at (3.8,3.5) {};
                                \node[circle, fill=black, minimum size=5pt, inner sep=0pt] (n343) at (4.8,3.5) {};
                                
                                \node[circle, fill=black, minimum size=5pt, inner sep=0pt] (n314) at (1.8,4.5) {};
                                \node[circle, fill=black, minimum size=5pt, inner sep=0pt] (n324) at (2.8,4.5) {};
                                \node[circle, fill=black, minimum size=5pt, inner sep=0pt] (n334) at (3.8,4.5) {};
                                \node[circle, fill=black, minimum size=5pt, inner sep=0pt] (n344) at (4.8,4.5) {};
