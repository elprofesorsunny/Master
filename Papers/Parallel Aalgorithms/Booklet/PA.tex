                        ...
                        \begin{tcolorbox}[colframe=black!50, colback=white, size=small]
                            ...
                            \begin{center}
                                \begin{tikzpicture}
                                    ...
                                    \node[circle, draw, fill=black!50] (n1) at (0,0) {};
                                    \node[circle, draw, fill=black!50] (n2) at (2,0) {};
                                    \node[circle, draw, fill=black!50] (n3) at (1,1) {};
                                    \node[circle, draw, fill=black!50] (n4) at (1,-1) {};
                                    \node[circle, draw, fill=black!50] (n5) at (0.3,0.7) {};
                                    \node[circle, draw, fill=black!50] (n6) at (0.3,-0.7) {};
                                    \node[circle, draw, fill=black!50] (n7) at (1.7,0.7) {};
                                    \node[circle, draw, fill=black!50] (n8) at (1.7,-0.7) {};
